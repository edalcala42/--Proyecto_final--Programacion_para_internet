        ...
        <div id="cid_4" class="form-input-wide" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_4" name="titulo" class="form-textbox" value="{{ $juego->titulo ?? ''}}" size="10" data-component="first" aria-labelledby="label_4 sublabel_4_first"/>
            ...
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
              <input type="date" id="last_4" name="fecha_de_publicacion" class="form-textbox" size="15" value="{{ $juego->fecha_de_publicacion ?? ''}}" data-component="last" aria-labelledby="label_4 sublabel_4_last" />
      ...
      <li class="form-line" data-type="control_fullname" id="id_4">
        ...
        <div id="cid_5" class="form-input-wide" data-layout="half">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="input_5" name="empresa_editora" style="width:310px" size="310" value="{{ $juego->empresa_editora ?? ''}}" aria-labelledby="label_5 sublabel_input_5" />
          </span>
        </div>
      </li>
