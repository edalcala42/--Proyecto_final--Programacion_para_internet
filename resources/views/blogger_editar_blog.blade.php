  ...
  <div role="main" class="form-all">
    ...
    <ul class="form-section page-section">
        ...
        <div id="cid_4" class="form-input-wide" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" value="{{ $blog->titulo ?? ''}}" id="first_4" name="titulo" class="form-textbox" size="10" data-component="first" aria-labelledby="label_4 sublabel_4_first"/>
      ...
      <li class="form-line" data-type="control_dropdown" id="id_7">
          <label class="form-label form-label-top form-label-auto" id="label_7" for="input_7"> Juego anteriormente configurado: {{ $blog->juego()->pluck('titulo') }}</label>
      ...
      <label class="form-label form-label-top form-label-auto" id="label_8" for="input_8"> Texto anterior: <br> {{ $blog->contenido ?? ''}} <br> </label>
        <label class="form-label form-label-top form-label-auto" id="label_8" for="input_8"> Texto del blog: </label>
        <div id="cid_8" class="form-input-wide" data-layout="full">
          <textarea id="input_8" class="form-textarea" name="contenido" style="width:648px;height:163px" data-component="textarea" aria-labelledby="label_8"></textarea>
        </div>
      </li>
