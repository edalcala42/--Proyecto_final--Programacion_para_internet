...
<script src="https://cdn02.jotfor.ms/static/jotform.forms.js?3.3.28740" type="text/javascript"></script>
<script defer src="https://cdnjs.cloudflare.com/ajax/libs/punycode/1.4.1/punycode.js"></script>
<script src="https://cdn03.jotfor.ms/js/vendor/imageinfo.js?v=3.3.28740" type="text/javascript"></script>
<script src="https://cdn01.jotfor.ms/file-uploader/fileuploader.js?v=3.3.28740"></script>
...
if (window.JotForm && JotForm.accessible) $('input_8').setAttribute('tabindex',0);
   ...
   JotForm.prepareCalculationsOnTheFly([null,{"name":"anadeUn","qid":"1","text":"Anade un nuevo juego a la libreria!","type":"control_head"},{"name":"submit","qid":"2","text":"Send Now!","type":"control_button"},null,{"name":"datos","qid":"4","text":"Datos","type":"control_fullname"},{"name":"companiaEditora","qid":"5","text":"Compania editora","type":"control_email"},{"name":"imagenQue","qid":"6","text":"Imagen que identifique al juego","type":"control_fileupload"},{"name":"categoria","qid":"7","text":"Categoria","type":"control_dropdown"},{"name":"descripcionDel","qid":"8","text":"Descripcion del juego","type":"control_textarea"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"anadeUn","qid":"1","text":"Anade un nuevo juego a la libreria!","type":"control_head"},{"name":"submit","qid":"2","text":"Send Now!","type":"control_button"},null,{"name":"datos","qid":"4","text":"Datos","type":"control_fullname"},{"name":"companiaEditora","qid":"5","text":"Compania editora","type":"control_email"},{"name":"imagenQue","qid":"6","text":"Imagen que identifique al juego","type":"control_fileupload"},{"name":"categoria","qid":"7","text":"Categoria","type":"control_dropdown"},{"name":"descripcionDel","qid":"8","text":"Descripcion del juego","type":"control_textarea"}]);}, 20); 
</script>
...
<link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/css/styles/payment/payment_styles.css?3.3.28740" />
<link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.28740" />
...
<form class="jotform-form" action="{{ route('generos.update', $genero) }}" method="POST" enctype="multipart/form-data">
  @if ($errors->any())
  ...
  <div role="main" class="form-all">
    ...
    <ul class="form-section page-section">
        ...
        <div id="cid_4" class="form-input-wide" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_4" name="nombre_genero" value="{{ $genero->nombre_genero ?? ''}}" class="form-textbox" size="10" data-component="first" aria-labelledby="label_4 sublabel_4_first"/>
              <label class="form-sub-label" for="first_4" id="sublabel_4_first" style="min-height:13px" aria-hidden="false"> Nombre </label>
            </span>
          </div>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_textarea" id="id_8">
        <br> Descripción previa: {{ $genero->descripcion_genero ?? ''}} <br><br>
        <label class="form-label form-label-top form-label-auto" id="label_8" for="input_8"> Descripción: </label>
        <div id="cid_8" class="form-input-wide" data-layout="full">
          <textarea id="input_8" class="form-textarea" name="descripcion_genero" style="width:648px;height:163px" data-component="textarea" aria-labelledby="label_8" value="{{ $juego->descripcion ?? ''}}"></textarea>
        </div>
      </li>
